...
function MedicineHover() {
  return (
        <div>
        <button className="flex items-center gap-1 text-sm font-medium text-gray-700 group-hover:text-[#8DC63F]">
               Medicine<FaChevronDown size={14} className="group-hover:rotate-180 transition-transform" />
              </button>

              <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 absolute -right-30 top-full w-max bg-white shadow-xl border border-gray-100 transition-all duration-200 z-50 p-6 rounded-b-xl">
